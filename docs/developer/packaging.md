...
# dist/dbrdemo-0.2.0.dev0+2026.09.25.42.abc123-py3-none-any.whl

# Test build
make release ENV=test DAILY_BUILD_NUMBER=42
# dist/dbrdemo-0.2.0b0+2026.09.25.42.abc123-py3-none-any.whl

# Acceptance build
make release ENV=acc DAILY_BUILD_NUMBER=42
# dist/dbrdemo-0.2.0rc0+2026.09.25.42.abc123-py3-none-any.whl
...
version and removes `.dist_version`, `.venv`, and build artifacts.
